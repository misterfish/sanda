...
var mapPairs = exports.mapPairs = (0, _ramda.curry)(function (f, obj) {
    return _op(obj, ifArray(_op2(_op2((0, _ramda.splitEvery)(2), (0, _ramda.map)(function (_ref5) {
        var _ref6 = _slicedToArray(_ref5, 2),
            k = _ref6[0],
            v = _ref6[1];

        return f(k, v);
    })), _ramda.fromPairs), _op2(_op2(_ramda.toPairs, (0, _ramda.map)(function (_ref7) {
...
// --- also works for functions curried with the a => b => ... notation.
// (unlike R?)
