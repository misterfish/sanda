...
var factory = exports.factory = function factory(proto) {
    ...
    return laat([mergeFish(mixinsPre, proto, mixinsPost)], function (protoExtended) {
        return {
            proto: protoExtended,
            create: function create(instanceExtension) {
                return _op(_op(protoExtended, Object.create), mergeToInMut(instanceExtension));
            }
        };
    });
};
