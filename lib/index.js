...
var ifOk__ = exports.ifOk__ = function ifOk__(x, yes, no) {
...
var ifLengthOne__ = exports.ifLengthOne__ = function ifLengthOne__(xs, yes, no) {
    return xs.length === 1 ? yes(xs) : no(xs);
};

var ifEmpty__ = exports.ifEmpty__ = function ifEmpty__(xs, yes, no) {
    return xs.length === 0 ? yes(xs) : no(xs);
};
...
var bindTry = exports.bindTry = (0, _ramda.curry)(function (o, prop) {
    return ifFunction(o[prop])(bind(o, prop));
});
...
var ifFunction__ = exports.ifFunction__ = function ifFunction__(x, yes) {
    return isFunction(x) ? yes(x) : void 8;
};
var ifFunction = exports.ifFunction = (0, _ramda.curry)(function (yes, x) {
    return ifFunction__(x, yes);
});
...
var Id = function () {
    ...
    return {
        of: function of(val) {
            return _op(_op(proto, Object.create), assocMut('val')(val));
        }
    };
}();
...
var doe = function doe() {
    for (var _len7 = arguments.length, mainArgs = Array(_len7), _key7 = 0; _key7 < _len7; _key7++) {
        mainArgs[_key7] = arguments[_key7];
    }

    var fs = _op(mainArgs, ifLengthOne(function (it) {
        return it[0];
    }, function (it) {
        return it;
    }));
