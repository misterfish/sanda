...
var whenTrue = exports.whenTrue = (0, _ramda.curry)(function (yes, x) {
    return _op(x, ifTrue(yes)(function () {
        return void 8;
    }));
});
...
var bindTry = exports.bindTry = (0, _ramda.curry)(function (o, prop) {
    return _op(bind(o, prop), ifFunction(_ramda.identity));
});
