...
var ifReplace = exports.ifReplace = (0, _ramda.curry)(function (yes, no, re, repl, target) {
    ...
    return _op(success, ifTrue(function () {
        return yes(out);
    }, function () {
        return no(target);
    }));
