...
var xRegExpStr = exports.xRegExpStr = function xRegExpStr(reStr) {
    return _op(_op(reStr, removeSpaces), nieuw1(RegExp));
};

// --- input: string, string.
var xRegExpStrFlags = exports.xRegExpStrFlags = function xRegExpStrFlags(reStr, flags) {
