...
var ifHas = (0, _ramda.curry)(function (yes, no, _ref) {
...
var whenHas = (0, _ramda.curry)(function (yes, spec) {
    return _op(spec, ifHas(yes)(noop));
});
var ifHas__ = function ifHas__(spec, yes) {
    var no = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : noop;
    return _op(spec, ifHas(yes)(no));
};

var ifHasIn = (0, _ramda.curry)(function (yes, no, _ref3) {
...
var whenHasIn = (0, _ramda.curry)(function (yes, spec) {
    return _op(spec, ifHasIn(yes)(noop));
});
var ifHasIn__ = function ifHasIn__(spec, yes) {
    var no = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : noop;
    return _op(spec, ifHasIn(yes)(no));
};

var ifBind = (0, _ramda.curry)(function (yes, no, _ref5) {
...
var ifBind__ = function ifBind__(spec, yes) {
    var no = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : noop;
...
var mergeToMut = exports.mergeToMut = (0, _ramda.curry)(function (tgt, src) {
    var ret = tgt;
    for (var i in src) {
        _op([src, i], whenHas(function (o, k, v) {
            return ret[k] = v;
        }));
    }return ret;
});
...
var mergeToWithMut = exports.mergeToWithMut = (0, _ramda.curry)(function (collision, tgt, src) {
    ...
    var _loop2 = function _loop2(i) {
        _op([src, i], whenHas(function (o, k, v) {
            _op([ret, i], ifHasIn(function (o, k, v) {
...
var givenStar = exports.givenStar = function givenStar(xs, f) {
    ...
    return _op(f, ifYes(passN(ys), function () {
        return (0, _ramda.last)(ys);
    }));
};
...
var sprintfN = exports.sprintfN = (0, _ramda.curry)(function (str, xs) {
    return sprintf.apply(null, [str].concat(_toConsumableArray(xs)));
});
...
var laatStarDat = exports.laatStarDat = (0, _ramda.curry)(function (fs, f, x) {
    return laatStar(_op(fs, (0, _ramda.map)(function (f) {
        return function () {
...
var ignore = function ignore(n) {
    return function (f) {
        return function () {
            ...
            return _op(_op(_op(args, splitAt(n)), prop(1)), applyN(f));
        };
    };
};