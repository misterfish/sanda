...
// --- 'to' refers to tgt
// --- does create a strange situation: if a collision occurs in the target's prototype chain:
//      if you choose the target version it stays in the underwater object
//      if you choose source it surfaces.
...
var mergeFish = exports.mergeFish = function mergeFish(mixinsPre, proto, mixinsPost) {
    ...
    _op(pre, mergeToWithMut(function (tgtVal, srcVal) {
        return tgtVal;
    })(proto));
