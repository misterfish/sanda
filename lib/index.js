...
// --------- regex.
var match = exports.match = (0, _ramda.curry)(function (regexp, target) {
    return regexp.exec(target);
});

// @deps: dot2
var xMatch = exports.xMatch = (0, _ramda.curry)(function (re, target) {
    return _op(_op(_op(_op(re, (0, _ramda.prop)('source')), dot2('replace')(/\s+/g, '')), nieuw1(RegExp)), dot1('exec', target));
});

var xMatchStr = exports.xMatchStr = (0, _ramda.curry)(function (str, target) {
    return _op(target, xMatch(new RegExp(str)));
});

var xRegExp = exports.xRegExp = function xRegExp(reStr) {
    return _op(_op(reStr, dot2('replace')(/\s+/g, '')), nieuw1(RegExp));
};

var ifReplace = exports.ifReplace = (0, _ramda.curry)(function (good, bad, wat, met, target) {
    var success = void 0;
    var out = target.replace(wat, function () {
        success = true;
        return met;
    });
    return _op(success, ifElseTrue(function () {
        return good(out);
    }, function () {
        return bad(target);
    }));
