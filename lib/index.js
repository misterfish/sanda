...
var ifOk = exports.ifOk = (0, _ramda.curry)(function (x, f) {
    return ok(x) ? f(x) : void 8;
});
...
var bind = exports.bind = function bind(o, key) {
    return function () {
...
var call = (0, _ramda.curry)(function (f, o) {
    return f.apply(o);
});
var isFunction = _op2(_op2(call({}.toString), dot2('slice')(8, -1)), (0, _ramda.equals)('Function'));
